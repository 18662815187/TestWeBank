...
<body>
	<form class="form-inline definewidth m20" action="work/queryAll"
		method="post">
		工单号： <input type="text" name="workorderid" id="workorderid"
			class="abc input-default" placeholder="工单编号"
			value="${vo.workorderid }">&nbsp;&nbsp; 客户姓名： <input
			type="text" name="customername" id="customername"
			class="abc input-default" placeholder="客户姓名查询"
			value="${vo.customername }">&nbsp;&nbsp; 证件号码：<input
			type="text" name="centificatenumber" id="centificatenumber"
			class="abc input-default" placeholder="证件号码查询"
			value="${vo.centificatenumber }">&nbsp;&nbsp;
		<!-- 状态： <input
			type="text" name="status" id="status" class="abc input-default"
			placeholder="状态查询" value="${vo.status}">&nbsp;&nbsp;  -->
		...
		<!--所在小组： <input
			type="text" name="handlegroup" id="handlegroup"
			class="abc input-default" placeholder="所在小组查询"
			value="${vo.handlegroup }">&nbsp;&nbsp; -->
	...
	<form action="work/queryAll" id="pager" method="post">
		...
		<input type="hidden" name="centificatenumber"
			value="${vo.centificatenumber}" /> <input type="hidden"
			name="status" value="${vo.status}" /> <input type="hidden"
			name="handlegroup" value="${vo.handlegroup}" /> <input type="hidden"
			name="handleperson" value="${vo.handleperson }" />
	</form>
